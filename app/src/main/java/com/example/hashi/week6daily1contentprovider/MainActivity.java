...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursorAdapter = new AdpterContacts(this, null, 0);
    ...
    private void insertContact(String contactName, String contactPhone) {
        ...
        values.put(LocalDb.CONTACT_NAME, contactName);
        values.put(LocalDb.CONTACT_PHONE, contactPhone);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this, ContactsProvider.CONTENT_URI, null,
                null, null, null);
    }
